...
namespace CoreWars.Engine {
    internal static class TokenizerExtentions {
        ...
        public static IEnumerable<string>
            ...
            yield return $"{"[Type]",-10} {"[Line]",-8} {"[Label]",-15} {"[Command]",-10} {"[ParameterA]",-20} {"[ParameterB]",-20}";
            ...
            foreach ((short LineNumber, string LineType, string Label, string Command, string ParameterA, string ParameterB) parsedCodeLine in parsedCodeLines) {
                ...
                string text = $"{parsedCodeLine.LineType,-10} {lineNumber,-8} {parsedCodeLine.Label,-15} {parsedCodeLine.Command,-10} {parsedCodeLine.ParameterA,-20} {parsedCodeLine.ParameterB,-20}";
                yield return text;
            }
        }
