namespace CoreWars.Engine.Extentions.Exceptions {
    public class LinterOpcodeMissingParameterBException : LinterException {
        public LinterOpcodeMissingParameterBException((short OpcodePointer, short LineNumber, string LineType, string Label, string Command, string ParameterA, string ParameterB) codeLine) 
