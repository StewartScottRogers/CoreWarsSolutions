namespace CoreWars.Engine.Extentions.Exceptions {
    public class LinterDirectiveMissingParameterAException : LinterException {
        public LinterDirectiveMissingParameterAException((short OpcodePointer, short LineNumber, string LineType, string Label, string Command, string ParameterA, string ParameterB) codeLine) 
