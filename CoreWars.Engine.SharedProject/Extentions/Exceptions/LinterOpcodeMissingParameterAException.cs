namespace CoreWars.Engine.Extentions.Exceptions {
    public class LinterOpcodeMissingParameterAException : LinterException {
        public LinterOpcodeMissingParameterAException((short LineNumber, string LineType, string Label, string Command, string ParameterA, string ParameterB) codeLine) 
