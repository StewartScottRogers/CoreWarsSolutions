...
namespace CoreWars.Engine.RedCodePrograms {
    internal static class RedCodeProgramStorage {
        ...
        public static (string Name, string Cotent, IEnumerable<(int lineNumber, string line)> Codelines) GetExample021() => GetEmbeddedProgram("Example021.redcode");
        public static (string Name, string Cotent, IEnumerable<(int lineNumber, string line)> Codelines) GetExample022() => GetEmbeddedProgram("Example022.redcode");
        public static (string Name, string Cotent, IEnumerable<(int lineNumber, string line)> Codelines) GetExample023() => GetEmbeddedProgram("Example023.redcode");
        public static (string Name, string Cotent, IEnumerable<(int lineNumber, string line)> Codelines) GetExample024() => GetEmbeddedProgram("Example024.redcode");
        public static (string Name, string Cotent, IEnumerable<(int lineNumber, string line)> Codelines) GetExample025() => GetEmbeddedProgram("Example025.redcode");
        public static (string Name, string Cotent, IEnumerable<(int lineNumber, string line)> Codelines) GetExample026() => GetEmbeddedProgram("Example026.redcode");
        public static (string Name, string Cotent, IEnumerable<(int lineNumber, string line)> Codelines) GetExample027() => GetEmbeddedProgram("Example027.redcode");
        public static (string Name, string Cotent, IEnumerable<(int lineNumber, string line)> Codelines) GetExample028() => GetEmbeddedProgram("Example028.redcode");
        public static (string Name, string Cotent, IEnumerable<(int lineNumber, string line)> Codelines) GetExample029() => GetEmbeddedProgram("Example029.redcode");
        public static (string Name, string Cotent, IEnumerable<(int lineNumber, string line)> Codelines) GetExample030() => GetEmbeddedProgram("Example030.redcode");

        public static (string Name, string Cotent, IEnumerable<(int lineNumber, string line)> Codelines) GetExample031() => GetEmbeddedProgram("Example031.redcode");
        public static (string Name, string Cotent, IEnumerable<(int lineNumber, string line)> Codelines) GetExample032() => GetEmbeddedProgram("Example032.redcode");
        public static (string Name, string Cotent, IEnumerable<(int lineNumber, string line)> Codelines) GetExample033() => GetEmbeddedProgram("Example033.redcode");
        public static (string Name, string Cotent, IEnumerable<(int lineNumber, string line)> Codelines) GetExample034() => GetEmbeddedProgram("Example034.redcode");
        public static (string Name, string Cotent, IEnumerable<(int lineNumber, string line)> Codelines) GetExample035() => GetEmbeddedProgram("Example035.redcode");
        public static (string Name, string Cotent, IEnumerable<(int lineNumber, string line)> Codelines) GetExample036() => GetEmbeddedProgram("Example036.redcode");
        public static (string Name, string Cotent, IEnumerable<(int lineNumber, string line)> Codelines) GetExample037() => GetEmbeddedProgram("Example037.redcode");
        public static (string Name, string Cotent, IEnumerable<(int lineNumber, string line)> Codelines) GetExample038() => GetEmbeddedProgram("Example038.redcode");
        public static (string Name, string Cotent, IEnumerable<(int lineNumber, string line)> Codelines) GetExample039() => GetEmbeddedProgram("Example039.redcode");
        public static (string Name, string Cotent, IEnumerable<(int lineNumber, string line)> Codelines) GetExample040() => GetEmbeddedProgram("Example040.redcode");
